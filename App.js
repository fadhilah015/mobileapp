...
export default class App extends React.Component<Props> {
  ...
  render () {
    return (
      ...
      <Text style={{fontSize: 40,color:'black',alignItems:'center' }}>calculate your age </Text>
        <View style={{margin:20,alignItems:'center',justifyContent:'center'}}>
          <TouchableOpacity style={{
            ...
            <Text style={{fontSize: 16}}>choice your birth day</Text> 
          </TouchableOpacity>
        </View>
        <DateTimePicker
        ...
        <View style={{
          ...
          <Text style={styles.text}>{this.state.calculated_year} </Text><Text style={styles.text1}> years</Text>
          <Text style={styles.text}>{this.state.calculated_month} </Text><Text style={styles.text1}> months</Text>
          <Text style={styles.text}>{this.state.calculated_date} </Text><Text style={styles.text1}> days</Text>
        </View>
      </View>
    );
  }
